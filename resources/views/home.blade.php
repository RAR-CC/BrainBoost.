...
@section('content')
    <div class="card">
        <div class="card-header" style="background: linear-gradient(189deg, #00E0FF -2.63%, #0083FF 45.96%, #011469 88.59%); color: white;">{{ __('Dashboard') }}</div>
        <div class="card-body">
            <div>
                ...
                <a href="/dokter/create" class="btn btn-primary m-1">Tambah Mentor</a>
            </div>
            <br>
            <div class="row">
